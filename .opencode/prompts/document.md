...
**🚀 START HERE**: Call `session_start(workflow_type: "document")` immediately to begin tracking this session.
...
- Call `session_start(workflow_type: "document")` - creates session file
...
1. **Submit your self-review**: Call `session_record_problem` with:
   ...
   - context: { "workflow_type": "document", "task_summary": "..." }
